              ...
              <div className="space-y-4 text-center md:text-left flex-1">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 pt-2">
                  <a 
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-xl glass hover:bg-surface-hover border border-border text-foreground text-sm font-semibold transition-colors"
                  >
                    <Mail size={16} className="text-primary" /> shihabatahar@gmail.com
                  </a>
                  <a 
