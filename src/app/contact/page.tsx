                ...
                <div className="space-y-5 pt-4 border-t border-border">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <a href="mailto:shihabatahar@gmail.com" className="text-foreground font-semibold text-sm hover:text-primary transition-colors truncate block">
                        shihabatahar@gmail.com
                      </a>
                    </div>
                  </div>

                  <div className="flex items-center gap-4">
                    <div className="p-3 rounded-xl bg-secondary/10 text-secondary border border-secondary/20 shrink-0">
                    ...
                    <div>
                      ...
                      <a href="https://github.com/Atahar-Shihab" target="_blank" rel="noopener noreferrer" className="text-foreground font-semibold text-sm hover:text-primary transition-colors">
                        github.com/Atahar-Shihab
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href="https://www.linkedin.com/in/atahar-shihab" target="_blank" rel="noopener noreferrer" className="text-foreground font-semibold text-sm hover:text-primary transition-colors">
                        linkedin.com/in/atahar-shihab
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href="https://www.facebook.com/atahar.shihab.740192/" target="_blank" rel="noopener noreferrer" className="text-foreground font-semibold text-sm hover:text-primary transition-colors">
                        facebook.com/atahar.shihab
                      </a>
                    </div>
                  </div>
                </div>
