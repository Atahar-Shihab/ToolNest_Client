        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a 
                ...
                className="p-2 rounded-full glass hover:bg-surface-hover text-muted hover:text-primary transition-colors border border-border" 
                aria-label="Email"
                title="shihabatahar@gmail.com"
              >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted">
              ...
              <li><a href="https://github.com/Atahar-Shihab/ToolNest_Client" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">Frontend Repo</a></li>
              <li><a href="https://github.com/Atahar-Shihab/ToolNest_Server" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">Backend Repo</a></li>
            </ul>
          </div>
          
          {/* Column 4: Contact & Creator */}
          <div>
            <h3 className="font-semibold mb-4 text-foreground">Developer Contact</h3>
            <p className="text-muted text-sm mb-2">Developed by <strong className="text-foreground">Atahar Shihab</strong></p>
            <p className="text-xs text-muted mb-4 truncate">shihabatahar@gmail.com</p>
            <a 
              href="mailto:shihabatahar@gmail.com" 
              className="inline-flex items-center gap-2 bg-primary hover:bg-primary/90 text-white px-4 py-2 rounded-xl text-sm font-semibold transition-colors shadow-md"
            >
